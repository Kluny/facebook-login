...
= 1.2.4 =
Updates to make plugin compliant with WordPress VIP code standard requirements.
* Added escaping and localization.
* Refactored redirects to prevent redirect attacks.
